/***************************************
 $Header: /home/amb/pic/projects/04_rs232-to-i2c/RCS/dumpeeprom.c,v 1.6 2008/05/04 13:53:32 amb Exp $

 Program to dump EEPROM on I2C connection.
 ******************/ /******************
...
int main(int argc, char **argv)
{
 ...
 if(argc!=3)
   {
    fprintf(stderr,"Usage: dumpeeprom <serial-device-name> <eeprom-size>\n");
    return(1);
   }
 ...
 fprintf(stderr,"\rReading: %6ld Bytes complete\n",size);
